...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String DB_NOMBRE = "CNE_DATPCP.db";
    public static final String TABLA_NOMBRE = "VOTANTES_DATPCP";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(String.format("create table %s (ID INTEGER PRIMARY KEY AUTOINCREMENT, %s TEXT , %s TEXT , %s INTEGER)", TABLA_NOMBRE, COL_1, COL_2, COL_3, COL_4, COL_5));
