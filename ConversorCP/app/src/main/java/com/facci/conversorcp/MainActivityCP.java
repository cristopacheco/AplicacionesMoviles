...
public class MainActivityCP extends AppCompatActivity {
    ...
    public void clickConvertir(View v){
        ...
        if (resultado>0){
            resultadoTV.setText(String.format("Por %5.2f %s , usted recibirá %5.2f %5",valorCambio,monedaActual,resultado,monedaCambio));
        ...
        resultadoTV.setText(String.format("Usted recibirá"));
            Toast.makeText(MainActivityCP.this,"Las opciones elegidas no tienen un factor de conversión",Toast.LENGTH_SHORT).show();
        }
